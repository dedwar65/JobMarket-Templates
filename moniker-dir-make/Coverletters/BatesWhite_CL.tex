...
Bates White’s platform—high-stakes litigation and advisory work with deep expertise in antitrust and competition, life sciences, and related practices—fits the way I work. I’m drawn to the firm’s model of pairing advanced econometrics and data science with clear, defensible narratives and expert testimony, as well as its structured mentorship and training for PhD Economists. I would welcome the chance to translate my technical work into expert reports, damages analyses, merger and conduct assessments, and client-facing presentations.

I believe I would be a strong fit because my computational and empirical toolkit allows me to (i) produce robust, data-backed estimates of returns and distributional outcomes, (ii) build and validate models that speak to corporate, regulatory, and litigation-driven challenges—such as antitrust liability and damages, merger analysis, and strategy under regulatory scrutiny—and (iii) collaborate across teams to present insights in concise, actionable formats for a client audience. I am excited by Bates White’s emphasis on rigorous analysis, mentorship, and teamwork—an environment where I expect my work to have tangible impact.

I would welcome the chance to discuss how my research program could support Bates White’s work. I do not have a preference regarding practice area or office location, and I’m glad to contribute wherever I can add the most value.
