...
As for the other chapters of my dissertation, I am currently working with HRS data to consider the relationship between trust and returns to net worth. There is much work that talks about the relationship between trust and economic growth in a country. There is also work that suggests there's a right amount of trust regarding maximizing an individual's income. My work contributes to this by seeking to establish a similar relationship for returns. We know that there is a persistent component to returns measured in many datasets, and perhaps trust can be added to the list of potential explanations for it (like financial sophiostication or entrepreneurial talent).
