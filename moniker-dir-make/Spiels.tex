...
For the first implication, when returns differ across households, a capital-income tax reduces wealth inequality more than an equivalent wealth tax, because it places a larger burden on households earning high returns.Second, from a welfare perspective, in this partial-equilibrium setting, capital-income taxation is preferred by most of the return-type groups—specifically, the bottom six out of seven. This matters because wealth and capital-income taxation are frequently debated in policy circles. My findings suggest that heterogeneity in returns should play a central role in evaluating such proposals, both for their distributional impact and for welfare consequences.
